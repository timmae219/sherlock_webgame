...
const rätsel_1_Antwort = "Wow, ja super. Genau das ist die Lösung! Vielen Dank.";
...
const rätsel_2_Antwort = "Sehr gut. Da bin ich ja echt baff wie`n Aff`! Dann bin ich wohl dran.";
...
const rätsel_3_Antwort = "Ja super, das ist ja ein praktischer Trick für die Prozentrechnung.";
...
const rätsel_4_Antwort = "Wunderbar, das ist goldrichtig! Nun bin ich an der Reihe.";
...
const rätsel_5_Antwort = "Du hast vollkommen recht, das stimmt. Nun bin ich gerne bereit dir alles zu sagen, was ich weiß.";
...
const rätsel_6_Antwort = "Ganz genau, so ist es. Also schön, ich sage dir alles, was ich weiß.";
...
const rätsel_7_Antwort = "Ja stimmt, genauso war es. Vielen Dank.";
...
const pig_catch = "Wunderbar, vielen lieben Dank. Jetzt ist meine kleine Wutz wieder da, wo sie hingehört.";
